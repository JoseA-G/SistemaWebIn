...
function Asignar() {
    ...
    tablahorario.rows().every(function (rowIdx, tableLoop, rowLoop) {
        ...
        if (
            data.oNivelDetalleCurso.oCurso.IdCurso == idcurso &&
            data.oNivelDetalleCurso.oGradoSeccion.IdGradoSeccion == idgradoseccion &&
    ...
    var request = {
        oHorario: {
            oNivelDetalleCurso: {
                ...
                oGradoSeccion: { IdGradoSeccion: idgradoseccion }, // Este es correcto
